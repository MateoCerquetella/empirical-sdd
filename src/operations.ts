...
export const SKILLS = Object.freeze([
  {
    id: "empirical",
    title: "Empirical",
    description: "Automatically initialize, route, resume, and complete Empirical work.",
  ...
  },
  {
    ...
    description: "Initialize or repair Empirical repository context without feature state.",
    entryOperation: "init",
    stopCondition: "Configuration applied, cancelled, or blocked.",
  },
  {
    id: "empirical-loop",
    title: "Empirical Loop",
    description: "Resume the selected feature through its next exact terminal result.",
    entryOperation: "loop",
    stopCondition: "Done, blocked, awaiting human, or authorization ceiling reached.",
  },
  {
    id: "empirical-socratic",
    title: "Empirical Socratic",
    description: "Conduct durable five-pass discovery and draft a Complex contract.",
    entryOperation: "explore",
    stopCondition: "Specify draft is waiting for approval, cancelled, or blocked.",
  },
  {
    id: "empirical-spec",
    title: "Empirical Spec",
    description: "Draft a concrete Complex contract and wait for approval.",
    entryOperation: "complex",
    stopCondition: "Specify draft is waiting for approval, cancelled, or blocked.",
  },
  {
    id: "empirical-yolo",
    title: "Empirical YOLO",
    description: "Run autonomously to an explicitly authorized safe completion ceiling.",
    entryOperation: "yolo",
    stopCondition: "Authorized ceiling reached, a product blocker remains, or a hard safety floor requires the user/host.",
  },
