...
if (typeof EmpiricalProject !== "function" || PRODUCT_VERSION !== "0.22.0" || SCHEMA_VERSION !== 5) throw new Error("root export mismatch");
...
if (EMPIRICAL_AGENT_SKILL_NAMES.length !== 6 || typeof uninstallGlobalAgentSkills !== "function") throw new Error("integration export mismatch");
let blocked = false;
